...
const BookingCard = (props) => {
    ...
    const cancelBooking = async () => {
        const res = await axios.delete(`/booking-cancel/${user?._id}/${property?._id}`)
        if (res.data.deleted) {
    ...
    const reportProperty = async () => {
        toast.success("Report has been submitted", { position: toast.POSITION.TOP_RIGHT })
    }
                ...
                <div className="mx-2">
                    ...
                    <form id='checkout-form'>
                                    ...
                                    property.category === "hotel" || property.category === "hostel" ?
                                        <>
                                            <div className='my-2' style={{ position: "relative" }}>
                                                ...
                                                <DatePicker id="startDateB" selected={startDate} onChange={(date) => changeStartDate(date)} style={{ position: "absolute", zIndex: "1", display: "none" }} />
                                            </div>
                                            ...
                                            <div className='my-2' style={{ position: "relative" }}>
                                                ...
                                                <DatePicker id="endDateB" selected={endDate} onChange={(date) => changeEndDate(date)} style={{ position: "absolute", zIndex: "1", display: "none" }} />
                                            </div>
                                            <div className="my-3">
                        ...
                        <div className='form-group my-3'>
                            ...
                            <input onChange={(e) => setOfferPrice(e.target.value)} className='form-control' type="number"></input>
                        </div>

                        <button onClick={() => booking()} type='button' className="btn btn-primary d-block w-100">
                            Buy Property
                        </button>
                    </form>
                    <hr />
                    <div className="d-flex justify-content-start align-items-center">
                        ...
                        <div className=" my-0 py-0 ms-2">
                            ...
                            <button onClick={cancelBooking} type='button' className="my-0 btn fw-bold text-secondary">
                                <i className="fa-solid fa-thumbs-up fs-4 me-1">
                                </i>Free Cancellation <br />
                            </button>
                    ...
                    <div className='d-flex justify-content-between'>
                        <div className="modal fade property-modal" data-backdrop="false" id="reportPropertyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div className="modal-dialog modal-dialog-centered">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <p className='m-0'><span><i className='fa-solid fa-info-circle me-1'></i></span>Report</p>
                                    ...
                                    <div class="modal-body">
                                        <div>
                                            <div className='py-2 px-2 d-flex' style={{ background: "#f1f1f1", borderLeft: "3px solid #707070" }}>
                                                <div>
                                                    <img className='rounded' src={`http://localhost:5000/${property?.images[0]}`} style={{ height: "6ch", width: "6ch", objectFit: "cover" }} alt="" />
                                                </div>
                                                <div className='mx-2'>
                                                    <small className='text-xs fw-bold'>{property?.title}</small>
                                                    <small className='text-xs d-block'>NPR {property?.price}</small>
                                                    <small className='text-xs d-block'>{property?.payment_type}</small>
                                                </div>
                                            </div>
                                            <div className='my-2'>
                                            ...
                                            <div className='my-2'>
                                                ...
                                                <textarea className='form-control text-sm' name="" id="" cols="30" rows="6"></textarea>
                                                <small className='text-xs'>Be specific with your reason to report this content.</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button onClick={reportProperty} type="button" className="btn btn-sm btn-info text-light">Report</button>
                                    </div>
                                </div>
                            </div>
                        </div>
