    ...
    <>
      ...
      <div className="container col-md-10 my-4">
        <div className="row mx-auto px-4">
                    <div className="col mb-4 me-md-3">
            <div className="px-3 py-2 border border-2 border-muted rounded mb-4">
              <div className="d-flex flex-wrap justify-content-between align-items-center mx-md-2 mx-sm-1 mb-3">
                <div className="">
                  <p className="h3 fw-bold text-xl" style={{ color: "#707070" }}>
            ...
            <div className="px-3 py-2 border border-2 border-muted rounded mb-4">
              <div className="d-flex flex-wrap justify-content-start align-items-center mx-md-3 mx-sm-1 py-3">
                ...
                <div className="ms-2">
                  ...
                  <Link to={'/profile'} className="btn btn-outline-primary px-4">
                    Visit Profile
                  </Link>
                </div>
              </div>
            ...
            <div className="px-3 py-2 border border-2 border-muted rounded mb-4">
              ...
              <img
                ...
                <div className="ms-2">
                  ...
                  <Link to={'/my-listings'} className="btn btn-outline-primary px-4">
                    View Listings
                  </Link>
                </div>
              </div>
            ...
            <div className="px-3 py-2 border border-2 border-muted rounded mb-4">
              ...
              <img
                ...
                <div className="ms-2">
                  ...
                  <Link to={'/list-property/category'} className="btn btn-outline-primary px-4">
                    List Property
                  </Link>
                </div>
              </div>
            ...
            <div className="px-3 py-2 border border-2 border-muted rounded mb-4">
              ...
              <img
                ...
                <div className="ms-2">
                  ...
                  <Link to={'/bookings/customer'} className="btn btn-outline-primary px-4">
                    Other Property Bookings
                  </Link>
                </div>
              </div>
